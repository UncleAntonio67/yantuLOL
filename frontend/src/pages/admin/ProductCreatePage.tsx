        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card title="封面图片" subtitle="可选，用于商品列表展示" className="lg:col-span-1">
            <div className="space-y-3">
              <div>
                ...
                />
                <div className="mt-1 text-xs text-gray-500">支持 png/jpg/webp，建议 1:1。</div>
              </div>
              <div>
              ...
              <div className="rounded-2xl border border-gray-100 bg-white/80 p-3">
                {coverPreviewUrl ? (
                  <img src={coverPreviewUrl} alt="cover preview" className="w-full aspect-square rounded-xl object-cover border border-gray-100 bg-white" />
                ) : (
          ...
          <Card title="PDF 附件" subtitle="支持上传多个，阅读页可切换查看" className="lg:col-span-3">
            <div>
              ...
              <div className="mt-1 text-xs text-gray-500">仅支持 PDF。发货后买家可在线查看，不可下载；确认收货后才开放下载。</div>
            </div>
          </Card>
